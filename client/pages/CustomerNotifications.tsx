        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Stay updated with your appointments, reports, and health updates
            </p>
          </div>
        ...
        <Tabs defaultValue="all" className="space-y-6">
          <TabsList>
            ...
            <TabsTrigger value="feedback">
              Feedback (
              {notifications.filter((n) => n.type === "feedback").length})
            </TabsTrigger>
          ...
          {["all", "appointment", "report", "feedback", "ambulance"].map(
            (tabType) => (
